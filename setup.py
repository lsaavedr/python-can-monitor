...
def get_version():
    # When some variables are defined in the dunder init of a project, import
    # of version.py can lead to circular dependencies. As a workaround, this
    # function reads the file version.py to get the package version.
    with open(
